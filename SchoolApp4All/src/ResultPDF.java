...
//			document.addAuthor("MAAULI EDUCATION SOCIETY");
            ...
            */
			...
			Chunk chunkStdDiv = new Chunk("            Std. Div.12345");
			...
			Chunk chunkGrNo = new Chunk("                                                     G.R. No.12");
			...
			// open pdf 
				...
				String fileAddress= "F:\\Eclipse_Project\\PDF\\itext-test.pdf";    //"D:\\java\\resume.pdf";
					try {
