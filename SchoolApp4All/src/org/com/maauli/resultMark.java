...
public class resultMark {
	 ...
	 public static void main(String[] args) {
	        ...
	        try {
	              ...
	              OutputStream file = new FileOutputStream(new File("D:\\yash\\result1.pdf"));
...
//					paragraph31.setSpacingBefore(-10);
		          ...
		          PdfPTable table=new PdfPTable(12);
				     table.setWidthPercentage(100);
		                     ...
		                     PdfPCell cell = new PdfPCell (new Paragraph ("Std.Div.", FontFactory.getFont(FontFactory.TIMES_BOLD, 10)));
					      cell.setColspan (1);
...
//					      cell.setBackgroundColor (new BaseColor (99, 99, 99));	
					      ...
					      PdfPCell cell1 = new PdfPCell (new Paragraph ("R.No.", FontFactory.getFont(FontFactory.TIMES_BOLD, 10)));
					      cell1.setColspan (1);
...
//					      cell2.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell3 = new PdfPCell (new Paragraph ("Name", FontFactory.getFont(FontFactory.TIMES_BOLD, 10)));
					      cell3.setColspan (6);
...
//					      cell3.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell4 = new PdfPCell (new Paragraph ("Date of Birth", FontFactory.getFont(FontFactory.TIMES_BOLD, 10)));
					      cell4.setColspan (2);
...
//					      cell4.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell5 = new PdfPCell (new Paragraph ("V-A", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell5.setColspan (1);
...
//					      cell5.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell6 = new PdfPCell (new Paragraph ("01", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell6.setColspan (1);
...
//					      cell6.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell7 = new PdfPCell (new Paragraph ("000001", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell7.setColspan (2);
...
//					      cell7.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell8 = new PdfPCell (new Paragraph ("RASHMI PARIKH", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell8.setColspan (6);
//					      cell8.setRowspan (7);
...
//					      cell8.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell9 = new PdfPCell (new Paragraph ("01/01/1985", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell9.setColspan (2);
//					      cell9.setRowspan (7);
...
//					      cell10.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell11 = new PdfPCell (new Paragraph ("SUBJECT", FontFactory.getFont(FontFactory.TIMES_BOLD, 10)));
					      cell11.setColspan (6);
//					      cell11.setRowspan (3);
...
//					      cell11.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell12 = new PdfPCell (new Paragraph ("MAXIMUM", FontFactory.getFont(FontFactory.TIMES_BOLD, 10)));
...
//					      cell12.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell13 = new PdfPCell (new Paragraph ("PASSING", FontFactory.getFont(FontFactory.TIMES_BOLD, 10)));
					      cell13.setColspan (2);
//					      cell13.setRowspan (3);
...
//					      cell13.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell14 = new PdfPCell (new Paragraph ("OBTAINED", FontFactory.getFont(FontFactory.TIMES_BOLD, 10)));
					      cell14.setColspan (2);
...
//					      PdfPCell cell19 = new PdfPCell (new Paragraph ("Marathi", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell19.setColspan (6);
...
//					      
//					      PdfPCell cell20 = new PdfPCell (new Paragraph ("100", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell20.setColspan (2);
...
//					      
//					      
//					      PdfPCell cell21 = new PdfPCell (new Paragraph ("35", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell21.setColspan (2);
////					      cell21.setRowspan (5);
...
//					      
//					      PdfPCell cell22 = new PdfPCell (new Paragraph ("51", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell22.setColspan (2);
////					      cell22.setRowspan (5);
...
//					      
//					      PdfPCell cell23 = new PdfPCell (new Paragraph ("HINDI", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell23.setColspan (6);
////					      cell23.setRowspan (5);
...
//					      
//					      PdfPCell cell24 = new PdfPCell (new Paragraph ("100", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell24.setColspan (2);
////					      cell24.setRowspan (5);
...
//					      
//					      PdfPCell cell25 = new PdfPCell (new Paragraph ("35", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell25.setColspan (2);
...
//					      
//					      PdfPCell cell26 = new PdfPCell (new Paragraph ("52", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell26.setColspan (2);
...
//					      
//					      PdfPCell cell27 = new PdfPCell (new Paragraph ("MATHEMATICS", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell27.setColspan (6);
...
//					      
//					      PdfPCell cell28 = new PdfPCell (new Paragraph ("100", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell28.setColspan (2);
...
//					      
//					      PdfPCell cell29 = new PdfPCell (new Paragraph ("35", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell29.setColspan (2);
...
//					      
//					      PdfPCell cell30 = new PdfPCell (new Paragraph ("53", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell30.setColspan (2);
...
//					      
//					      PdfPCell cell31 = new PdfPCell (new Paragraph ("SCIENCE", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell31.setColspan (6);
...
//					      
//					      PdfPCell cell32 = new PdfPCell (new Paragraph ("100", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell32.setColspan (2);
...
////					   
//					      PdfPCell cell33 = new PdfPCell (new Paragraph ("35", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell33.setColspan (2);
...
//					      
//					      PdfPCell cell34 = new PdfPCell (new Paragraph ("54", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell34.setColspan (2);
...
//					      
//					      PdfPCell cell35 = new PdfPCell (new Paragraph ("SOCIAL STUDIES", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell35.setColspan (6);
...
//					      
//					      PdfPCell cell36 = new PdfPCell (new Paragraph ("100", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell36.setColspan (2);
...
//					      
//					      PdfPCell cell37 = new PdfPCell (new Paragraph ("35", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell37.setColspan (2);
...
//					      
//					      PdfPCell cell38 = new PdfPCell (new Paragraph ("55", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell38.setColspan (2);
...
//					      
//					      PdfPCell cell39 = new PdfPCell (new Paragraph ("DRAWING", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell39.setColspan (6);
...
//					      
//					      PdfPCell cell40 = new PdfPCell (new Paragraph ("100", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell40.setColspan (2);
...
//					      
//					      PdfPCell cell41 = new PdfPCell (new Paragraph ("35", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell41.setColspan (2);
...
//					      
//					      PdfPCell cell42 = new PdfPCell (new Paragraph ("56", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
//					      cell42.setColspan (2);
...
//					      table.addCell(cell58);
					      ...
					      PdfPCell cell59 = new PdfPCell (new Paragraph ("Total", FontFactory.getFont(FontFactory.TIMES_BOLD, 10)));
					      cell59.setColspan (6);
...
//					      cell59.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell60 = new PdfPCell (new Paragraph ("800", FontFactory.getFont(FontFactory.TIMES_BOLD, 10)));
					      cell60.setColspan (2);
...
//					      cell60.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      ...
					      PdfPCell cell61 = new PdfPCell (new Paragraph ("300", FontFactory.getFont(FontFactory.TIMES_BOLD, 10)));
					      cell61.setColspan (2);
...
//					      cell61.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell62 = new PdfPCell (new Paragraph ("500", FontFactory.getFont(FontFactory.TIMES_BOLD, 10)));
					      cell62.setColspan (2);
...
//					      cell62.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      Chunk chunk101 = new Chunk("Attendance : 30/50");
...
//							font101.setColor(BaseColor.RED);
							...
							Chunk chunk101a = new Chunk("                                                                                                          Percentage :   50%satisfatory");
...
//							font101a.setColor(BaseColor.RED);
							...
							paragraph101a.setSpacingBefore(-15);
