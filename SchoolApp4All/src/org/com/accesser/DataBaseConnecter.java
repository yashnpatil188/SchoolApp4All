...
//		iSessionInterval = Integer.parseInt(sessionData1.getConfigMap().get("SESSION_INTERVAL"));
//
//		ringtonePath = sessionData1.getConfigMap().get("RINGTONE_DIR");
//		sUpdateCatchURL="";
//		for(int i=1;i<100;i++)
//		{
//			try
//			{
//				sUpdateCatchURL  = sUpdateCatchURL + "," + sessionData1.getConfigMap().get("UPDATE_DATA_URL_"+i);
//			}
//			catch(Exception e)
//			{
//				break;
//			}
//		}
//		sVideoStartId = sessionData1.getConfigMap().get("VIDEO_START_ID");
//
...
//			boolean temp = true;
//			try{
//				str  = sessionData1.getConfigMap().get("isEventId").trim();
...
//				try
//				{
//					contentTypes[i] = sessionData1.getConfigMap().get("CONT"+i).trim();
//					NumberOfContents++;
//				}
//				catch(Exception e)
//				{
...
//			try
//			{
//				contentNumber= Integer.parseInt(sessionData1.getConfigMap().get("ContentNumber").trim());
//			}
...
//
//			//Library
//			noOfInstance = sessionData1.getConfigMap().get("NO_OF_INSTANCES");
...
//				try
//				{
//					String dbname = sessionData1.getConfigMap().get("DB_NAME_"+(i+1)).trim();
//					String dbpool = sessionData1.getConfigMap().get("DB_POOL_NAME_"+(i+1)).trim();
//					String dburl  = sessionData1.getConfigMap().get("DB_URL_"+(i+1)).trim();
//					String dbuser = sessionData1.getConfigMap().get("DB_USER_"+(i+1)).trim();
//					String dbpwd  = sessionData1.getConfigMap().get("DB_PASSWD_"+(i+1)).trim();
//					String nfspath = sessionData1.getConfigMap().get("DB_FILE_PATH_"+(i+1)).trim();
//
//					libDBName[i] = dbname;
...
//				try
//				{
//					String fieldName = sessionData1.getConfigMap().get("Meta"+i).trim();
...
//					//boxTypes[i] = sessionData1.getConfigMap().get("Meta"+i).trim();
//					NumberOfBoxes++;
//				}
//				catch(Exception e)
//				{
...
//				try
//				{
//					deliveryTypes[i] = sessionData1.getConfigMap().get("DELIVERY"+i).trim();
...
//			boolean temp = true;
//			try{
//				str  = sessionData1.getConfigMap().get("isText").trim();
//				if (str.trim().equals("0")){
//					temp = false;
//				}
//				else
...
//			boolean temp = true ;
//			try{
//				str  = sessionData1.getConfigMap().get("isContentIsKeyword");
//				if (str.trim().equals("0")){
//					temp = false;
//				}
//				else
...
//		try
//		{
//			dbpl_source = sessionData1.getConfigMap().get("DB_POOL_NAME");
//			connectionType = sessionData1.getConfigMap().get("CONNECTION_TYPE");
//
//
//			dbdriver_str = sessionData1.getConfigMap().get("DBDRIVER");
//	        dburl_str = sessionData1.getConfigMap().get("DBURL");
//	        dbuser_str = sessionData1.getConfigMap().get("DBUSER");
//	        dbpasswd_str = sessionData1.getConfigMap().get("DBPASSWD");
//
//
//	        strPlanId= sessionData1.getConfigMap().get("planId");
//			strMasterId = sessionData1.getConfigMap().get("masterId");
//			str_rapsvc = sessionData1.getConfigMap().get("_rapsvc");
//			strProviderId= sessionData1.getConfigMap().get("providerId");
//			strRapServiceId= sessionData1.getConfigMap().get("rapServiceId");
//			strClassificationId= sessionData1.getConfigMap().get("classificationId");
//			strRapDeviceMake = sessionData1.getConfigMap().get("rapDeviceMake");
//			strRapDeviceModel= sessionData1.getConfigMap().get("rapDeviceModel");
//			strRapSubId = sessionData1.getConfigMap().get("rapSubId");
//
//
//			//sUpdateCatchURL = sessionData1.getConfigMap().get("UPDATE_DATA_URL");
//	        ONELINELOGPATH = sessionData1.getConfigMap().get("onelinelogpath");
//
//		}
//		catch(Exception e){
