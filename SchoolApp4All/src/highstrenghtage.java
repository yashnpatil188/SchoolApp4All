...
public class highstrenghtage{
	
	 public static void main(String[] args) {

	        try {

	              OutputStream file = new FileOutputStream(new File("D:\\yash\\highstrengthage.pdf"));
...
//					      cell2.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell3 = new PdfPCell (new Paragraph ("V", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell3.setColspan (2);
...
//					      cell3.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell4 = new PdfPCell (new Paragraph ("VI", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell4.setColspan (2);
...
//					      cell4.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell5 = new PdfPCell (new Paragraph ("VII", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell5.setColspan (2);
...
//					      cell5.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell6 = new PdfPCell (new Paragraph ("VIII", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell6.setColspan (2);
...
//					      cell6.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell6a = new PdfPCell (new Paragraph ("IX", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell6a.setColspan (2);
					      cell6a.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell6a.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell6a.setPadding (10.0f);
//					      cell6a.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      table.addCell(cell6a);
					      
					      PdfPCell cell6b = new PdfPCell (new Paragraph ("X", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell6b.setColspan (2);
					      cell6b.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell6b.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell6b.setPadding (10.0f);
//					      cell6b.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      table.addCell(cell6b);
...
//					      cell15.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell14a = new PdfPCell (new Paragraph ("Boys", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell14a.setColspan (1);
					      cell14a.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell14a.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell14a.setPadding (10.0f);
//					      cell14a.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      table.addCell(cell14a);
					      
					      
					      PdfPCell cell15a = new PdfPCell (new Paragraph ("Girls", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell15a.setColspan (1);
					      cell15a.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell15a.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell11.setPadding (10.0f);
//					      cell15a.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      table.addCell(cell15a);
					      
					      PdfPCell cell14b = new PdfPCell (new Paragraph ("Boys", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell14b.setColspan (1);
					      cell14b.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell14b.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell14b.setPadding (10.0f);
//					      cell14b.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      table.addCell(cell14b);
					      
					      
					      PdfPCell cell15b = new PdfPCell (new Paragraph ("Girls", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell15b.setColspan (1);
					      cell15b.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell15b.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell15b.setPadding (10.0f);
//					      cell15b.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      table.addCell(cell15b);
					      
					      
					      PdfPCell cell16 = new PdfPCell (new Paragraph (" ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 3)));
					      cell16.setColspan (13);
...
//					      cell16.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell17 = new PdfPCell (new Paragraph ("9", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell17.setColspan (1);
...
//					      cell18.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell19 = new PdfPCell (new Paragraph ("22", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell19.setColspan (1);
...
//					      cell25.setPadding (10.0f);
					      ...
					      PdfPCell cell24a = new PdfPCell (new Paragraph (" ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell24a.setColspan (1);
//					      cell24a.setRowspan (5);
					      cell24a.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell24a.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell24a.setPadding (10.0f);
					      cell24a.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      table.addCell(cell24a);
					      
					      PdfPCell cell25a = new PdfPCell (new Paragraph (" ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell25a.setColspan (1);
					      cell25a.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell25a.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell25a.setPadding (10.0f);
					      cell25a.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      table.addCell(cell25a);
					      
					      PdfPCell cell24b = new PdfPCell (new Paragraph (" ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell24b.setColspan (1);
//					      cell24b.setRowspan (5);
					      cell24b.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell24b.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell24b.setPadding (10.0f);
					      cell24b.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      table.addCell(cell24b);
					      
					      PdfPCell cell25b = new PdfPCell (new Paragraph (" ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell25b.setColspan (1);
					      cell25b.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell25b.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell25b.setPadding (10.0f);
					      cell25b.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      table.addCell(cell25b);
					      
					      PdfPCell cell26 = new PdfPCell (new Paragraph ("10", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell26.setColspan (1);
...
//					      cell27.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell28 = new PdfPCell (new Paragraph ("22", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell28.setColspan (1);
...
//					      cell28.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell29 = new PdfPCell (new Paragraph ("11", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell29.setColspan (1);
...
//					      cell29.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      ...
					      PdfPCell cell30 = new PdfPCell (new Paragraph ("22", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell30.setColspan (1);
//					      cell30.setRowspan (5);
...
//					      cell34.setPadding (10.0f);
					      ...
					      PdfPCell cell33a = new PdfPCell (new Paragraph (" ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell33a.setColspan (1);
//					      cell33a.setRowspan (5);
					      cell33a.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell33a.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell33a.setPadding (10.0f);
					      cell33a.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      table.addCell(cell33a);
					      
					      PdfPCell cell34a = new PdfPCell (new Paragraph (" ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell34a.setColspan (1);
					      cell34a.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell34a.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell34a.setPadding (10.0f);
					      cell34a.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      table.addCell(cell34a);
					      
					      PdfPCell cell33b = new PdfPCell (new Paragraph (" ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell33b.setColspan (1);
//					      cell33b.setRowspan (5);
					      cell33b.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell33b.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell33b.setPadding (10.0f);
					      cell33b.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      table.addCell(cell33b);
					      
					      PdfPCell cell34b = new PdfPCell (new Paragraph (" ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell34b.setColspan (1);
					      cell34b.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell34b.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell34b.setPadding (10.0f);
					      cell34b.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      table.addCell(cell34b);
			      
					      
					      PdfPCell cell35 = new PdfPCell (new Paragraph ("11", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell35.setColspan (1);
...
//					      cell36.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell37 = new PdfPCell (new Paragraph ("22", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell37.setColspan (1);
...
//					      cell37.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell38 = new PdfPCell (new Paragraph ("11", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell38.setColspan (1);
...
//					      cell38.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      ...
					      PdfPCell cell39 = new PdfPCell (new Paragraph ("22", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell39.setColspan (1);
//					      cell39.setRowspan (5);
...
//					      cell39.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      ...
					      PdfPCell cell40 = new PdfPCell (new Paragraph ("11", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell40.setColspan (1);
//					      cell40.setRowspan (5);
...
//					      cell40.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      ...
					      PdfPCell cell41 = new PdfPCell (new Paragraph ("22", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell41.setColspan (1);
//					      cell41.setRowspan (5);
...
//					      cell43.setPadding (10.0f);
					      ...
					      PdfPCell cell42a = new PdfPCell (new Paragraph (" ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell42a.setColspan (1);
//					      cell42a.setRowspan (5);
					      cell42a.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell42a.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell42a.setPadding (10.0f);
					      cell42a.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      table.addCell(cell42a);
					      
					      PdfPCell cell43a = new PdfPCell (new Paragraph (" ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell43a.setColspan (1);
					      cell43a.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell43a.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell43a.setPadding (10.0f);
					      cell43a.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      table.addCell(cell43a);
					      
					      PdfPCell cell42b = new PdfPCell (new Paragraph (" ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell42b.setColspan (1);
//					      cell42b.setRowspan (5);
					      cell42b.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell42b.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell42b.setPadding (10.0f);
					      cell42b.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      table.addCell(cell42b);
					      
					      PdfPCell cell43b = new PdfPCell (new Paragraph (" ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell43b.setColspan (1);
					      cell43b.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell43b.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell43b.setPadding (10.0f);
					      cell43b.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      table.addCell(cell43b);
					      
					      
					      PdfPCell cell44 = new PdfPCell (new Paragraph ("12", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell44.setColspan (1);
...
//					      cell45.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell46 = new PdfPCell (new Paragraph ("22", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell46.setColspan (1);
...
//					      cell46.setBackgroundColor (new BaseColor (140, 221, 8));					               
					      ...
					      PdfPCell cell47 = new PdfPCell (new Paragraph ("11", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell47.setColspan (1);
...
//					      cell47.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      ...
					      PdfPCell cell48 = new PdfPCell (new Paragraph ("22", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell48.setColspan (1);
//					      cell48.setRowspan (5);
...
//					      cell50.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      ...
					      PdfPCell cell51 = new PdfPCell (new Paragraph ("11", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell51.setColspan (1);
//					      cell51.setRowspan (5);
...
//					      cell51.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      ...
					      PdfPCell cell52 = new PdfPCell (new Paragraph ("22", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell52.setColspan (1);
...
//					      cell52.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      ...
					      PdfPCell cell51a = new PdfPCell (new Paragraph ("11", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell51a.setColspan (1);
//					      cell51a.setRowspan (5);
					      cell51a.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell51a.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell51a.setPadding (10.0f);
//					      cell51a.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      table.addCell(cell51a);
					      
					      PdfPCell cell52a = new PdfPCell (new Paragraph ("22", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell52a.setColspan (1);
					      cell52a.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell52a.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell52a.setPadding (10.0f);
//					      cell52a.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      table.addCell(cell52a);
					      
					      PdfPCell cell51b = new PdfPCell (new Paragraph (" ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell51b.setColspan (1);
//					      cell51b.setRowspan (5);
					      cell51b.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell51b.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell51b.setPadding (10.0f);
					      cell51b.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      table.addCell(cell51b);
					      
					      PdfPCell cell52b = new PdfPCell (new Paragraph (" ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
					      cell52b.setColspan (1);
					      cell52b.setHorizontalAlignment (Element.ALIGN_CENTER);
					      cell52b.setVerticalAlignment (Element.ALIGN_MIDDLE);
//					      cell52b.setPadding (10.0f);
					      cell52b.setBackgroundColor (new BaseColor (110, 110, 110));					               
					      table.addCell(cell52b);
...
//		              
		                ...
		                float[] columnWidths = new float[] {10f, 10f, 10f, 10f, 10f, 10f, 10f, 10f, 10f, 10f, 10f, 10f, 10f};
